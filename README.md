...
`language` | `string` | `False` | Requested<sup>*</sup> language(s) for state and attributes. Two-Letter language code(s), separated by commas.<br><sup>*</sup>Refer to Notes | location's local language
