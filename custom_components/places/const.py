...
PERSISTED_ATTRIBUTE_LIST: list[str] = [
    ATTR_CITY,
    ATTR_CITY_CLEAN,
    ATTR_COUNTRY,
    ATTR_COUNTY,
...
EVENT_ATTRIBUTE_MAP: dict[str, str] = {
    ...
    "last_changed": ATTR_LAST_CHANGED,
    "distance_from_home": ATTR_DISTANCE_FROM_HOME,
    "distance_traveled": ATTR_DISTANCE_TRAVELED,
    "direction_of_travel": ATTR_DIRECTION_OF_TRAVEL,
    "previous_latitude": ATTR_LATITUDE_OLD,
    "previous_longitude": ATTR_LONGITUDE_OLD,
    "map_link": ATTR_MAP_LINK,
    "osm_id": ATTR_OSM_ID,
    "osm_type": ATTR_OSM_TYPE,
}
